    ...
    class Program
    {
        ...
        starting: Console.Write("0-999.999 arasında bir pozitif tam sayı giriniz : "); //burada kullanıcıya ne istediğimizi belirtiyoruz.
            ...
            if (sayi >= 0) //SAYININ 0 DAN BÜYÜK OLDUĞU DURUMDA YANİ POZİTİF OLMASI DURUMUNU KONTROL EDİYORUZ.
            {
                ...
                {
                    if (yuzBinler != 0 && yuzBinler == 1)
                    {
                        Console.Write(birlik[yuzBinler - 1] + " " + "yüz ");
                    ...
                    else if (yuzler == 0 || yuzler == 1)
                    {
                        Console.Write(onluk[onBinler] + " ");

                        //if (binler == 1)
                        //{
                        //    Console.Write(birlik[binler - 1] + " bin ");
                        //}
                        //else
                        if (yuzler == 1)
                        {
                            Console.Write(birlik[yuzler - 1] + "yüz");
                        }
                    ...
                    {
                        if (binler == 1 && onBinler == 0)
                        {
                            Console.Write(birlik[binler - 1] + "bin");
                        }
                        else if (binler == 1 && onBinler != 0)
                        {
                            Console.Write(onluk[onBinler] + " ");
                ...
                {
                    if (yuzler != 0 && yuzler != 1)
                    {
                        Console.Write(birlik[yuzler] + " " + "yüz ");
                    }
                    else if (yuzler == 1 || onlar == 0)
                    {
                        Console.Write("yüz");
